...
TOTAL_CLIENTS = 39251688

#FRACTIONING
CLUSTER1 = int(math.floor(TOTAL_CLIENTS* 0.04046893))
CLUSTER2 = int(math.floor(TOTAL_CLIENTS* 0.1208241))
CLUSTER3 = int(math.floor(TOTAL_CLIENTS* 0.1682846))
CLUSTER4 = int(math.floor(TOTAL_CLIENTS* 0.0293526))
CLUSTER5 = int(math.floor(TOTAL_CLIENTS* 0.1355993))
CLUSTER6 = int(math.floor(TOTAL_CLIENTS* 0.06087371))
CLUSTER7 = int(math.floor(TOTAL_CLIENTS* 0.1988988))
CLUSTER8 = int(math.floor(TOTAL_CLIENTS* 0.245698))
